...
async fn test_cached_price_returned() {
    ...
    let price = historical_market_data::get_closing_price(&db, &asset, "2025-01-02")
        .await
        .unwrap();
...
async fn test_forward_fill_from_previous() {
    ...
    let price = historical_market_data::get_closing_price(&db, &asset, "2025-01-07")
        .await
        .unwrap();
...
async fn test_forward_fill_prefers_recent() {
    ...
    let price = historical_market_data::get_closing_price(&db, &asset, "2025-01-03")
        .await
        .unwrap();
